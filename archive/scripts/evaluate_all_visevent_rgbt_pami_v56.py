...
def main():
    datasets = {
        "VisEvent": {
            ...
            "results_dir": "/mnt/task_runtime/workspace/results/VisEvent/flextrackv2_b224_56",
            "gt_filename": "groundtruth.txt"
        },
        "VisEvent_miss": {
            "gt_dir": "/mnt/task_wrapper/user_output/artifacts/visevent/test",
            "results_dir": "/mnt/task_runtime/workspace/results/VisEvent_miss/flextrackv2_b224_56",
            "gt_filename": "groundtruth.txt"
        },
        "LasHeR": {
            "gt_dir": "/mnt/task_wrapper/user_output/artifacts/lasher/lasher/testingset",
            "results_dir": "/mnt/task_runtime/workspace/results/LasHeR/flextrackv2_b224_56",
            "gt_filename": "init.txt"
        },
        "LasHeR_miss": {
            "gt_dir": "/mnt/task_wrapper/user_output/artifacts/lasher/lasher/testingset",
            "results_dir": "/mnt/task_runtime/workspace/results/LasHeR_miss/flextrackv2_b224_56",
            "gt_filename": "init.txt"
        },
        "RGBT234": {
            "gt_dir": "/mnt/task_wrapper/user_output/artifacts/rgbt234/rgbt234",
            "results_dir": "/mnt/task_runtime/workspace/results/RGBT234/flextrackv2_b224_56",
            "gt_filename": "visible.txt"
        },
        "RGBT234_miss": {
            "gt_dir": "/mnt/task_wrapper/user_output/artifacts/rgbt234/rgbt234",
            "results_dir": "/mnt/task_runtime/workspace/results/RGBT234_miss/flextrackv2_b224_56",
            "gt_filename": "visible.txt"
        },
        "DepthTrack": {
            "gt_dir": "/mnt/task_wrapper/user_output/artifacts/Depthtrack_workspace/sequences",
            "results_dir": "/mnt/task_runtime/workspace/results/depthtrack/flextrackv2_b224_56",
            "gt_filename": "groundtruth.txt"
        },
        "DepthTrack_miss": {
            "gt_dir": "/mnt/task_wrapper/user_output/artifacts/Depthtrack_workspace/sequences",
            "results_dir": "/mnt/task_runtime/workspace/results/depthtrack_miss/flextrackv2_b224_56",
            "gt_filename": "groundtruth.txt"
        }
    }

    print("==========================================================================================")
    print("                 FlexTrackV2 V54 (BMR-HMoE) IEEE TPAMI Benchmark Evaluation                 ")
    print("==========================================================================================")
    ...
    for name, paths in datasets.items():
        ...
        elif "LasHeR" in name or "RGBT234" in name or "DepthTrack" in name:
