...
mci_dir = "/mnt/task_runtime/workspace/results/VisEvent/flextrackv2_b224_56"
flex_dir = "/mnt/task_runtime/workspace/results/VisEvent/FlexTrack"

print(f"--- Evaluating VisEvent (full) on {len(seqs)} sequences ---")
...
print(f"flextrackv2_v56 | Success (AUC): {mci_auc:.2f}% | Precision (PR): {mci_pr:.2f}%")
print(f"FlexTrack    | Success (AUC): {flex_auc:.2f}% | Precision (PR): {flex_pr:.2f}%")
