...
def evaluate_dataset(results_dir, gt_dir, seqs, gt_filename, is_flextrack=False):
    iou_list = []
    distance_list = []
    norm_distance_list = []
...
def main():
    datasets = {
        "DepthTrack": {
            ...
            "flex_res": "/mnt/task_runtime/workspace/results/depthtrack/FlexTrack",
            "gt_filename": "groundtruth.txt"
        },
        "DepthTrack_miss": {
            "gt_dir": "/mnt/task_wrapper/user_output/artifacts/Depthtrack_workspace/Depthtrack_workspace/sequences",
            "mci_res": "/mnt/task_runtime/workspace/results/depthtrack_miss/flextrackv2_b224_56",
            "flex_res": "/mnt/task_runtime/workspace/results/depthtrack_miss/FlexTrack",
            "gt_filename": "groundtruth.txt"
        },
        "RGBT234": {
            "gt_dir": "/mnt/task_wrapper/user_output/artifacts/rgbt234/rgbt234",
            "mci_res": "/mnt/task_runtime/workspace/results/RGBT234/flextrackv2_b224_56",
            "flex_res": "/mnt/task_runtime/workspace/results/RGBT234/FlexTrack",
            "gt_filename": "visible.txt"
        },
        "RGBT234_miss": {
            "gt_dir": "/mnt/task_wrapper/user_output/artifacts/rgbt234/rgbt234",
            "mci_res": "/mnt/task_runtime/workspace/results/RGBT234_miss/flextrackv2_b224_56",
            "flex_res": "/mnt/task_runtime/workspace/results/RGBT234_miss/FlexTrack",
            "gt_filename": "visible.txt"
        },
        "LasHeR": {
            "gt_dir": "/mnt/task_wrapper/user_output/artifacts/lasher/lasher/testingset",
            "mci_res": "/mnt/task_runtime/workspace/results/LasHeR/flextrackv2_b224_56",
            "flex_res": "/mnt/task_runtime/workspace/results/LasHeR/FlexTrack",
            "gt_filename": "init.txt"
        },
        "LasHeR_miss": {
            "gt_dir": "/mnt/task_wrapper/user_output/artifacts/lasher/lasher/testingset",
            "mci_res": "/mnt/task_runtime/workspace/results/LasHeR_miss/flextrackv2_b224_56",
            "flex_res": "/mnt/task_runtime/workspace/results/LasHeR_miss/FlexTrack",
            "gt_filename": "init.txt"
        }
    }
    ...
    for name, paths in datasets.items():
        ...
        mci_auc, mci_pr, mci_npr = evaluate_dataset(mci_dir, gt_dir, seqs, gt_filename, is_flextrack=False)
        print_result("FlexTrackV2 V56", mci_auc, mci_pr, mci_npr)
        
        flex_auc, flex_pr, flex_npr = evaluate_dataset(flex_dir, gt_dir, seqs, gt_filename, is_flextrack=True)
