...
print('1. Cleaning old results...')
run_cmd('rm -rf /mnt/task_runtime/workspace/results/*/flextrackv2_b224_56')

print('2. Running Parallel Tracking for DepthTrack & RGBT (V56)...')
cmds = [
    'cd /mnt/task_runtime && CUDA_VISIBLE_DEVICES=0,1 /coreflow/venv/bin/python RGBT_workspace/test_depthtrack_mgpus.py --script_name flextrackv2 --dataset_name depthtrack --yaml_name flextrackv2_b224_56 --mode parallel --threads 8 --num_gpus 2 --epoch 40',
    'cd /mnt/task_runtime && CUDA_VISIBLE_DEVICES=2,3 /coreflow/venv/bin/python RGBT_workspace/test_depthtrack_mgpus.py --script_name flextrackv2 --dataset_name depthtrack_miss --yaml_name flextrackv2_b224_56 --mode parallel --threads 8 --num_gpus 2 --epoch 40',
    'cd /mnt/task_runtime && CUDA_VISIBLE_DEVICES=4 /coreflow/venv/bin/python RGBT_workspace/test_rgbt_mgpus.py --script_name flextrackv2 --dataset_name LasHeR --yaml_name flextrackv2_b224_56 --mode parallel --threads 4 --num_gpus 1 --epoch 40',
    'cd /mnt/task_runtime && CUDA_VISIBLE_DEVICES=5 /coreflow/venv/bin/python RGBT_workspace/test_rgbt_mgpus.py --script_name flextrackv2 --dataset_name LasHeR_miss --yaml_name flextrackv2_b224_56 --mode parallel --threads 4 --num_gpus 1 --epoch 40',
    'cd /mnt/task_runtime && CUDA_VISIBLE_DEVICES=6 /coreflow/venv/bin/python RGBT_workspace/test_rgbt_mgpus.py --script_name flextrackv2 --dataset_name RGBT234 --yaml_name flextrackv2_b224_56 --mode parallel --threads 4 --num_gpus 1 --epoch 40',
    'cd /mnt/task_runtime && CUDA_VISIBLE_DEVICES=7 /coreflow/venv/bin/python RGBT_workspace/test_rgbt_mgpus.py --script_name flextrackv2 --dataset_name RGBT234_miss --yaml_name flextrackv2_b224_56 --mode parallel --threads 4 --num_gpus 1 --epoch 40'
]
