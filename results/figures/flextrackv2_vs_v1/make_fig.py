...
CONFIGS={
 "LasHeR_full":   dict(seq="boyscomeleft", imgs=f"{LASHER}/boyscomeleft/visible", exts=["*.jpg"],
                       gt=f"{LASHER}/boyscomeleft/visible.txt",
                       v2=f"{FR}/LasHeR/boyscomeleft.txt", v1=("gen",f"{V1}/LasHER/boyscomeleft.txt")),
