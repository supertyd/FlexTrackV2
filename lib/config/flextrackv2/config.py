...
# MODEL.ENCODER
# for more customization for encoder, please modify lib/models/flextrackv2/vit.py
...
cfg.MODEL.MOE = edict()
cfg.MODEL.MOE.TYPE = "DIFFERENT"
# --- BMR-HMoE mechanism ablation switches (defaults = full method behavior) ---
# SUBSTITUTE_MODE: how a missing modality's tokens are filled before fusion.
#   "hallucinate" = use the cross-modal hallucinated features (BMR, default);
#   "zero" = leave them zeroed (plain masking baseline).
cfg.MODEL.MOE.SUBSTITUTE_MODE = "hallucinate"
# USE_RECON_LOSS: apply the bilateral self-supervised reconstruction loss.
cfg.MODEL.MOE.USE_RECON_LOSS = True
# HALLUCINATE_DIRECTION: which cross-modal reconstruction paths are active.
#   "bilateral" (default) | "rgb2aux" (only RGB->Aux) | "aux2rgb" (only Aux->RGB)
cfg.MODEL.MOE.HALLUCINATE_DIRECTION = "bilateral"
# USE_ORTHO: apply the gate-router orthogonality regularizer.
cfg.MODEL.MOE.USE_ORTHO = True

# TRAIN
cfg.TRAIN = edict()
cfg.TRAIN.LR = 0.0001
cfg.TRAIN.WEIGHT_DECAY = 0.0001
cfg.TRAIN.DISTILL_WEIGHT = 1.0
cfg.TRAIN.CMA_P_MIN = 0.10
cfg.TRAIN.CMA_P_MAX = 0.50
cfg.TRAIN.EPOCH = 500
...
# Path to the trained checkpoint, relative to the project root (or absolute).
# The production config points this at the released FlexTrackV2 weights so the
# model is fully self-describing -- no hidden checkpoint redirect in the loader.
cfg.TEST.CHECKPOINT = ""
...
cfg.TEST.UPT.RGBT234 = 0
cfg.TEST.UPT.LASHER_MISS = 0
cfg.TEST.UPT.DEPTHTRACK_MISS = 0
cfg.TEST.UPT.VISEVENT_MISS = 0
cfg.TEST.UPT.RGBT234_MISS = 0
...
cfg.TEST.UPH.RGBT234 = 0
cfg.TEST.UPH.LASHER_MISS = 0
cfg.TEST.UPH.DEPTHTRACK_MISS = 0
cfg.TEST.UPH.VISEVENT_MISS = 0
cfg.TEST.UPH.RGBT234_MISS = 0
...
cfg.TEST.INTER.RGBT234 = 0
cfg.TEST.INTER.LASHER_MISS = 0
cfg.TEST.INTER.DEPTHTRACK_MISS = 0
cfg.TEST.INTER.VISEVENT_MISS = 0
cfg.TEST.INTER.RGBT234_MISS = 0
...
cfg.TEST.MB.RGBT234 = 0
cfg.TEST.MB.LASHER_MISS = 0
cfg.TEST.MB.DEPTHTRACK_MISS = 0
cfg.TEST.MB.VISEVENT_MISS = 0
cfg.TEST.MB.RGBT234_MISS = 0
