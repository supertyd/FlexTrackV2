...
def main():
    ...
    elif args.mode == "multiple":  # python -m torch.distributed.launch /torchrun
        train_cmd = "python -m torch.distributed.launch --nproc_per_node %d --master_port  %d --use_env lib/train/run_training.py " \
