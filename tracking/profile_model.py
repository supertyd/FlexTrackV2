...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='flextrackv2',
                        help='training script name')
    parser.add_argument('--config', type=str, default='flextrackv2_b224', help='yaml configure file name')
...
if __name__ == "__main__":
    ...
    hanning = None
    '''import flextrackv2 network module'''
    model_module = importlib.import_module('lib.models.flextrackv2')
    model_constructor = model_module.build_flextrackv2
